...
require_line "EnvironmentFile=-/etc/default/igh-ethercat-diagnostics"
require_line 'ExecStart=/usr/local/bin/igh-ethercat-diagnostics --masters ${IGH_DIAG_MASTERS}'
